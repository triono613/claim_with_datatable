...
switch ($_POST['kode']) {
		...
		// echo "<pre>";
		// echo "ext: "; print_r( $ext ); echo "<br>";
		// echo "fileName: "; print_r( $fileName ); echo "<br>";
		// echo "fileTmp: "; print_r( $fileTmp ); echo "<br>";
...
function treaty_name($data){
	...
	// $sqlQuery = "select ti.no_treaty as no_contract,ti.id from tbl_insured ti where ti.ceding='$data' limit 100 ";
	$dataQuery = $database->db_fetch_array($sqlQuery);
