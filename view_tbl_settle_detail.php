...
$query = "select * from tbl_claim_settle a where a.file_name ='$_POST[file_name]' and (claim_insd_name LIKE '%".$search."%' OR claim_policy_no LIKE '%".$search."%'  OR claim_certificate_no LIKE '%".$search."%' ) ";
