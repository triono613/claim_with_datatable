...
$sql = "select id from tbl_setting_uw order by id ";
$cc= $db->db_row_count($sql);



// $query = "SELECT * FROM tbl_setting_uw WHERE (insured_name LIKE '%".$search."%' OR policy_no LIKE '%".$search."%'  OR certificate_no LIKE '%".$search."%' )";
$query = "SELECT * FROM tbl_setting_uw ";
